...
function Navbar({ additional }: { additional?: string }) {
  const input = useRef<HTMLInputElement>(null);

  return (
    <div
      className={`flex items-center justify-between gap-6 px-4 pt-6 sm:px-6 md:px-10 md:pt-8 lg:px-16 xl:justify-center ${additional}`}
    >
